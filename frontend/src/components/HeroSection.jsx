...
const VIDEOS = [
  ...
  },
  {
    src: "ToyTrain.mp4",
    poster:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Kapaleeshwarar_temple_Chennai.jpg/1200px-Kapaleeshwarar_temple_Chennai.jpg",
  ...
  },
  {
    ...
    poster:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Shore_Temple_2.jpg/1200px-Shore_Temple_2.jpg",
      ...
      <div className="hero__container">
        ...
        <div className="hero__left">
          ...
          <p className="hero__subtitle fade-up fade-up--d2">
            TravelBuddy is built by explorers, for explorers — with
            curated itineraries, hidden gems, and cinematic experiences
            that bring Tamil Nadu to life.
          </p>
